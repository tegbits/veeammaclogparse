...
from constant.config.configEnum import SECRET_EMAIL, SECRET_PASS, SENDER_EMAIL, HTTP_HOST, HTTP_IP
...
def sendDataInEmail(data, emails=SENDER_EMAIL, templateType = JOB_TYPE):
    ...
    with smtplib.SMTP_SSL(HTTP_HOST, HTTP_IP, context=context) as smtp:
        try:
